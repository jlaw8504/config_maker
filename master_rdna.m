function master_rdna(seed, cond_num, steps, step_path, chromo_cmd)
cd(step_path);
%define basename
basename = sprintf('rdna_s%d_c%d', seed, cond_num);
%add desired number of condensins to .cfg file
add_condensin_linear(seed, '50um_chain.cfg', sprintf('%s.cfg', basename), cond_num);
%Run first iteration
