function dumbbell(seed, cond_num)
cd('/home1/lawrimor/config_maker');
add_condensin_bracelet(seed, 'kb30_twodumbbell_bracelet.cfg', sprintf('kb30_s%d_c%d.cfg', seed, cond_num), cond_num);
cd('/home1/lawrimor/add_condensin');
system(sprintf('/home1/lawrimor/source/brownianMotion/chromoShake/chromoShake -openCL_dir $HOME/source/brownianMotion/chromoShake/ -save $HOME/add_condensin/kb30_s%d_c%d_0000.out 5000 10 $HOME/config_maker/kb30_s%d_c%d.cfg',seed, cond_num, seed, cond_num));
...
while n < 1001
	...
	system(sprintf('/home1/lawrimor/source/brownianMotion/chromoShake/chromoShake -openCL_dir $HOME/source/brownianMotion/chromoShake/ -save $HOME/add_condensin/kb30_s%d_c%d_%s%d', seed, cond_num, str_pad, n));
